...
#read_parasitic_tech -tlup $TLUPLUS_NOMINAL_FILE -layermap $MAP_FILE
...
############################################################
set_attribute [get_layers met1] routing_direction vertical
set_attribute [get_layers met2] routing_direction horizontal
set_attribute [get_layers met3] routing_direction vertical
set_attribute [get_layers met4] routing_direction horizontal
set_attribute [get_layers met5] routing_direction vertical
set_attribute [get_layers met6] routing_direction horizontal
set_attribute [get_layers met7] routing_direction vertical
set_attribute [get_layers met8] routing_direction horizontal
set_attribute [get_layers met9] routing_direction vertical
set_attribute [get_layers mcon] routing_direction horizontal

set_wire_track_pattern -site_def unit -layer met1  -mode uniform -mask_constraint {mask_two mask_one} \
...
connect_pg_net -net $NDM_POWER_NET [get_pins -hierarchical "*/VPWR"]
connect_pg_net -net $NDM_GROUND_NET [get_pins -hierarchical "*/VGND"]
...
create_pg_mesh_pattern P_top_two \
	-layers { \
		{ {horizontal_layer: met4} {width: 0.2} {spacing: interleaving} {pitch: 30} {offset: 0.856} {trim : true} } \
		{ {vertical_layer: met5}   {width: 0.2} {spacing: interleaving} {pitch: 30} {offset: 6.08}  {trim : true} } \
	}
...
## Create std rail
#VDD VSS
create_pg_std_cell_conn_pattern std_rail_conn1 -rail_width 0.094 -layers met1
...
create_routing_rule ROUTE_RULES_1 \
	-widths {met2 0.3 met3 0.3 } \
	-spacings {met2 0.42 met3 0.63 }

set_clock_routing_rules -default_rule -min_routing_layer met2 -max_routing_layer met4
...
## std filler
set pnr_std_fillers "sky130_fd_sc_hd__fill_*"
set std_fillers ""
...
report_timing -max_paths 1 -delay_type max -sort_by slack -scenarios func_slow > ${IP}/asic/reports/max_crit_path_for_icc2.txt
